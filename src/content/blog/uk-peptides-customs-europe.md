...
1. **Ask directly for the dispatch country** — a specific EU member state, not "Europe" or "an EU location"
2. **Check your tracking link** — the tracking number prefix and carrier portal will show the parcel's origin scan location
3. **Look at the sender address on the parcel** — a UK address on the label = UK dispatch
4. **Check for customs forms** — an EU-dispatched parcel arrives with no customs documentation attached
