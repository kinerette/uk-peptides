...
|---|---|
| COA availability | Per-batch, downloadable, with chromatogram |
| Synthesis disclosure | GMP-compliant synthesis facility stated |
| Labelling | Clear RUO designation, lot number, storage conditions |
| Communication | Technical queries answered with specificity, not marketing copy |
| Returns/reorders | Policy for quality disputes |
